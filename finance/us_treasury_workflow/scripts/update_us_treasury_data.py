...
CONFIG = {
    # 数据文件路径
    'data_file': os.path.join(DATA_DIR, 'us_treasury_yields_all_terms.csv'),
    
    # mx-macro-data 技能路径
    'mx_macro_skill_path': r'D:\OpenClawData\.openclaw\workspace\skills\mx-macro-data',
    
    # R 可视化脚本路径
    'r_script': os.path.join(SCRIPT_DIR, 'us_treasury_workflow_v2.R'),
    
    # 输出 HTML 文件
    'output_html': os.path.join(DATA_DIR, '..', 'us_treasury_all_terms.html'),
