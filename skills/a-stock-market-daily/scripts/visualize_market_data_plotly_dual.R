...
# 生成情绪指数+成交额、情绪指数+融资余额交互式图表
#
# 依赖: install.packages(c('readr','dplyr','plotly','htmlwidgets','lubridate'))
#
...
# 文件路径配置
DATA_FILE <- "finance/tushare/market_combined_data.csv"
OUTPUT_DIR <- "finance/visualization"
...
start_date_obj <- end_date_obj - days(days_num)
